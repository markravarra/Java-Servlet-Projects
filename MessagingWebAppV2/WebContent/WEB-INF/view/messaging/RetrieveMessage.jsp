...
<title>Retrieve Messages Page</title>
	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-8 text-left"
				...
				<div class="container-fluid">
					<h1>Messages Retrieved</h1>
					<h4>
						<font color="red"><c:if test='${not empty info}'>
							<c:out value="${info}" />
						</c:if></font>
					</h4>
					<table class="table table-striped table-dark">
						<thead class="thead-light" style="color: blue;">
							<tr>
						...
						<tbody>
							<c:forEach var="msg" items="${messages}">
								<tr>
									...
									<td><b>${msg.message}</b></td>
									<td><b>${msg.dateAndTimeSent}</b></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
			...
			<div class="col-sm-2 sidenav">
				<div>
					<font color="white"><h3>Online Users</h3></font>
				</div>
				<div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="actionsBtns">
						<form action="logout?userID=${userID}" method="post">
